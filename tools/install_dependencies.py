    ...
    def install(self):
        ...
        if platform.system() == 'Windows':
            ...
            if struct.calcsize("P")*8 == 64:
                urllib.urlretrieve('https://github.com/lachlangrose/GeoTrace/raw/master\
                /windows_installers/Cython-0.27.2-cp27-cp27m-win_amd64.whl'\
                ,'Cython-0.27.2-cp27-cp27m-win_amd64.whl')
                urllib.urlretrieve('https://github.com/lachlangrose/GeoTrace/raw/master\
                /windows_installers/scikit_image-0.13.1-cp27-cp27m-win_amd64.whl'\
            ...
            if struct.calcsize("P")*8==32:
                urllib.urlretrieve('https://github.com/lachlangrose/GeoTrace/raw/master/\
                windows_installers/Cython-0.27.2-cp27-cp27m-win32.whl'\
                ,'Cython-0.27.2-cp27-cp27m-win32.whl')
                urllib.urlretrieve('https://github.com/lachlangrose/GeoTrace/raw/master/\
                windows_installers/scikit_image-0.13.1-cp27-cp27m-win32.whl'\
